...
readonly bazel_cmd=(
  ...
  "/Users/franklinmelo/Library/Caches/bazelisk/downloads/sha256/6e9274042665163de666f13b87abfe187a9127ed90ff1142bf42cfd45b32cd2b/bin/bazel"
...
"$BAZEL_INTEGRATION_DIR/process_bazel_build_log.py" \
  ...
  "$output_groups_flag" \
  "@@rules_xcodeproj_generated//generator/Draw/xcodeproj:xcodeproj" \
...
if [[ -n "${target_ids:-}" ]]; then
  if [[ ! -s "$PROJECT_DIR/bazel-out/darwin_x86_64-dbg/bin/external/rules_xcodeproj_generated/generator/Draw/xcodeproj/xcodeproj_target_ids" ]]; then
      echo "error: \"$PROJECT_DIR/bazel-out/darwin_x86_64-dbg/bin/external/rules_xcodeproj_generated/generator/Draw/xcodeproj/xcodeproj_target_ids\" was not created. This can happen if" \
...
"https://github.com/MobileNativeFoundation/rules_xcodeproj/issues/new?template=bug.md" \
  ...
  diff_output=$(comm -23 <(printf '%s\n' "${target_ids[@]}") "$PROJECT_DIR/bazel-out/darwin_x86_64-dbg/bin/external/rules_xcodeproj_generated/generator/Draw/xcodeproj/xcodeproj_target_ids")
